...
export interface ApiBannerBanner extends Struct.SingleTypeSchema {
  ...
  attributes: {
    animateLine1: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    animateLine2: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    animateLine3: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiChatMessageChatMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sender: Schema.Attribute.Enumeration<['visitor', 'admin']> &
      Schema.Attribute.Required;
    session: Schema.Attribute.Relation<
      'manyToOne',
      'api::chat-session.chat-session'
    >;
    telegramFileId: Schema.Attribute.String;
...
export interface ApiChatSessionChatSession extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    sessionId: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    stage: Schema.Attribute.Enumeration<['active', 'closed']> &
      Schema.Attribute.DefaultTo<'active'>;
    telegramTopicId: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visitorName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'N\u00E1v\u0161t\u011Bvn\u00EDk'>;
  };
}
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    linkToMap: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    linkToReserve: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    publishedAt: Schema.Attribute.DateTime;
    socItems: Schema.Attribute.Component<'items.soc-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    galery: Schema.Attribute.Media<'images' | 'videos', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    leftNav: Schema.Attribute.Component<'items.nav-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    rightNav: Schema.Attribute.Component<'items.nav-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiOfferOffer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    offerRendered: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPersonalPersonal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    work_time: Schema.Attribute.Relation<
      'oneToMany',
